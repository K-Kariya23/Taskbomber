...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    ...
                    <a class="nav-link" aria-current="page" href="login.php">ログイン</a>
                    </li>
                </ul>
                </div>
            </div>
        ...
        <div class="bg-light p-5 rounded">
            ...
            <p class="lead">これは退会ページです. <br>退会する方はフォームに名前とパスワードを書き込んでください.<br></p>
            <form action="" method="post">
                <fieldset>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" id="disabledTextInput" name="password" class="form-control" placeholder="Enter Your Task">
                    </div>
                    <button type="submit" class="btn btn-primary">Submit</button>
                </fieldset>
            </form>
                <?php if(array_key_exists("name", $_POST) && array_key_exists("password", $_POST)): ?>
                        <?php $pdo->exit($_POST["name"], $_POST["password"])?>
                <?php endif ?>
            <br>
        </div>
